	...
	const saveProfile = async (e) => {
		...
		try {
			if (
				...
				const response = await fetch('https://api.cloudinary.com/v1_1/dtgajx2ak/image/upload', {
					method: 'post',
					body: image,
				});
			...
			const userData = {
				...
				picture: profileImage ? imageURL : profile.picture,
			};
							...
							{!isLoading && user && (
								<>
									<div className='profile-photo'>
										<div>
											<img src={imagePreview === null ? user?.picture : imagePreview} alt='Profileimg' />
