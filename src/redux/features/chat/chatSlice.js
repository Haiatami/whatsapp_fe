...
const CONVERSATION_ENDPOINT = `${process.env.REACT_APP_BACKEND_URL}/api/v1/conversation`;
const MESSAGE_ENDPOINT = `${process.env.REACT_APP_BACKEND_URL}/api/v1/message`;
...
export const { setActiveConversation, updateMessagesAndConversations, addFiles, clearFiles, removeFileFromFiles } =
	chatSlice.actions;
