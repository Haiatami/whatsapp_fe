...
import { addFiles } from '../../../../../redux/features/chat/chatSlice.js';
...
export default function DocumentAttachment() {
	...
	return (
		<li>
			...
			<input type='file' hidden multiple ref={inputRef} accept='application/*,text/plain' onChange={documentHandler} />
		</li>
	);
}
