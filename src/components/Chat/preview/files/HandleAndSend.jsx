...
import { removeFileFromFiles, sendMessage } from '../../../../../redux/features/chat/chatSlice.js';
...
const HandleAndSendWithContext = (props) => (
	<SocketContext.Consumer>{(socket) => <HandleAndSend {...props} socket={socket} />}</SocketContext.Consumer>
);
